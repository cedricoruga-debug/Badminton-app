 ...
 * 6-digit code (told to them by the queue master in person) plus their
 * name; it lands as a pending request the queue master approves or
 * declines from the dashboard's "Join requests" panel — this page never
 * registers anyone by itself. Modeled on the login page's layout (centered
 * card, no nav chrome) since it's the other page a signed-out visitor can
 * reach.
 */
